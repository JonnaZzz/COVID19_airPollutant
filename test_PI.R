...
write.csv(predict_count,"result/weekly_predict_PI.csv")
...
ggsave("result/prediction_PI.pdf", pl)
...
ggsave("result/annual_excess_PI.pdf", pl)
...
write.csv(eval_matrix,'result/model_valdiation_evaluation_PI.csv',quote=F,row.names = FALSE)
